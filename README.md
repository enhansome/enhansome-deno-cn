...
* [@denoland/deno](https://github.com/denoland/deno) ⭐ 108,325 | 🐛 1,529 | 🌐 Rust | 📅 2026-08-27：🌟。Deno 核心仓库。
...
* [@denoland/deno\_std](https://github.com/denoland/deno_std) ⭐ 3,560 | 🐛 315 | 🌐 TypeScript | 📅 2026-08-03：🌟。Deno 标准库。
* [@cacjs/cac](https://github.com/cacjs/cac) ⭐ 3,126 | 🐛 35 | 🌐 TypeScript | 📅 2026-06-16：🌟。用于构建命令行应用程序的简单但功能强大的框架。
...
* [@drashland/drash](https://github.com/drashland/deno-drash) ⭐ 1,067 | 🐛 1 | 🌐 TypeScript | 📅 2026-08-27：零依赖性的 Deno HTTP 服务器的 REST 微框架。
...
* [@keroxp/servest](https://github.com/keroxp/servest) ⭐ 719 | 🐛 10 | 🌐 TypeScript | 📅 2022-10-19：渐进式 HTTP 服务器/路由器。
...
* [@asos-craigmorten/superdeno](https://github.com/asos-craigmorten/superdeno) ⭐ 123 | 🐛 1 | 🌐 TypeScript | 📅 2026-08-25：🌟。由超级代理驱动的库，用于测试 Deno HTTP 服务器。
* [@drashland/rhum](https://github.com/drashland/rhum) ⚠️ Archived：用于 Deno 的轻量级测试框架。
...
* [@denoland/vscode-deno](https://github.com/denoland/vscode_deno) ⭐ 1,547 | 🐛 124 | 🌐 TypeScript | 📅 2026-07-02：🌟。VS Code 扩展。
...
* [@sindresorhus/type-fest](https://github.com/sindresorhus/type-fest) ⭐ 17,384 | 🐛 226 | 🌐 TypeScript | 📅 2026-08-26：基本 TypeScript 类型的集合（sindresorhus端口/ type-fest）。
...
* [@hayd/deno-docker](https://github.com/hayd/deno-docker) ⭐ 1,018 | 🐛 18 | 🌐 Dockerfile | 📅 2026-08-27：hayd 的几个 docker 映像。
* [@divy-work/autopilot](https://github.com/divy-work/autopilot-deno) ⭐ 503 | 🐛 9 | 🌐 Rust | 📅 2022-07-22：🌟。用于 Deno 的跨平台桌面自动化框架。
...
* [@github-profile-trophy](https://github.com/ryo-ma/github-profile-trophy) ⭐ 6,638 | 🐛 32 | 🌐 TypeScript | 📅 2026-07-25：🏆 在你的 README 文件中添加动态生成的 GitHub Trophy。
...
* [@avelino/awesome-go](https://github.com/avelino/awesome-go) ⭐ 182,456 | 🐛 218 | 🌐 Go | 📅 2026-08-27。
* [@sindresorhus/awesome-nodejs](https://github.com/sindresorhus/awesome-nodejs) ⭐ 66,635 | 🐛 26 | 📅 2026-05-03。
* [@rust-unofficial/awesome-rust](https://github.com/rust-unofficial/awesome-rust) ⭐ 59,008 | 🐛 7 | 🌐 Rust | 📅 2026-08-27。
...
本项目贡献者列表遵循 [all-contributors](https://github.com/all-contributors/all-contributors) ⭐ 8,093 | 🐛 89 | 🌐 MDX | 📅 2026-08-27 规范。欢迎你的参与，本仓库[贡献准则](./CONTRIBUTING.md)！
