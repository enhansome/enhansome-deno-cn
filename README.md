...
* [@denoland/deno](https://github.com/denoland/deno) ⭐ 108,467 | 🐛 1,590 | 🌐 Rust | 📅 2026-09-17：🌟。Deno 核心仓库。
...
* [@denoland/deno\_std](https://github.com/denoland/deno_std) ⭐ 3,565 | 🐛 323 | 🌐 TypeScript | 📅 2026-09-17：🌟。Deno 标准库。
* [@cacjs/cac](https://github.com/cacjs/cac) ⭐ 3,133 | 🐛 38 | 🌐 TypeScript | 📅 2026-08-28：🌟。用于构建命令行应用程序的简单但功能强大的框架。
...
* [@denoland/vscode-deno](https://github.com/denoland/vscode_deno) ⭐ 1,547 | 🐛 126 | 🌐 TypeScript | 📅 2026-07-02：🌟。VS Code 扩展。
...
* [@sindresorhus/type-fest](https://github.com/sindresorhus/type-fest) ⭐ 17,409 | 🐛 228 | 🌐 TypeScript | 📅 2026-09-17：基本 TypeScript 类型的集合（sindresorhus端口/ type-fest）。
...
* [@hayd/deno-docker](https://github.com/hayd/deno-docker) ⭐ 1,018 | 🐛 18 | 🌐 Dockerfile | 📅 2026-09-17：hayd 的几个 docker 映像。
* [@divy-work/autopilot](https://github.com/divy-work/autopilot-deno) ⭐ 503 | 🐛 9 | 🌐 Rust | 📅 2022-07-22：🌟。用于 Deno 的跨平台桌面自动化框架。
...
* [@github-profile-trophy](https://github.com/ryo-ma/github-profile-trophy) ⭐ 6,654 | 🐛 33 | 🌐 TypeScript | 📅 2026-07-25：🏆 在你的 README 文件中添加动态生成的 GitHub Trophy。
...
* [@avelino/awesome-go](https://github.com/avelino/awesome-go) ⭐ 184,505 | 🐛 230 | 🌐 Go | 📅 2026-09-16。
* [@sindresorhus/awesome-nodejs](https://github.com/sindresorhus/awesome-nodejs) ⭐ 66,836 | 🐛 25 | 📅 2026-09-02。
* [@rust-unofficial/awesome-rust](https://github.com/rust-unofficial/awesome-rust) ⭐ 59,387 | 🐛 12 | 🌐 Rust | 📅 2026-09-17。
