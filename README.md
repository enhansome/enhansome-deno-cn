...
* [x] 及时跟进 [@denolib/awesome-deno](https://github.com/denolib/awesome-deno) ⭐ 4,412 | 🐛 2 | 📅 2026-08-12 仓库。
...
* [@denoland/deno](https://github.com/denoland/deno) ⭐ 108,249 | 🐛 1,482 | 🌐 Rust | 📅 2026-08-13：🌟。Deno 核心仓库。
...
* [@denoland/deno\_std](https://github.com/denoland/deno_std) ⭐ 3,555 | 🐛 303 | 🌐 TypeScript | 📅 2026-08-03：🌟。Deno 标准库。
* [@cacjs/cac](https://github.com/cacjs/cac) ⭐ 3,120 | 🐛 35 | 🌐 TypeScript | 📅 2026-06-16：🌟。用于构建命令行应用程序的简单但功能强大的框架。
...
* [@irandeno/coffee](https://github.com/irandeno/coffee) ⭐ 33 | 🐛 0 | 🌐 TypeScript | 📅 2020-08-25：Deno 配置——一种类型安全、易于使用的 Deno 配置管理器。
...
* [@denoland/vscode-deno](https://github.com/denoland/vscode_deno) ⭐ 1,548 | 🐛 126 | 🌐 TypeScript | 📅 2026-07-02：🌟。VS Code 扩展。
...
* [@xcatliu/pagic](https://github.com/xcatliu/pagic) ⭐ 1,656 | 🐛 12 | 🌐 JavaScript | 📅 2023-09-19：用 Deno 构建从 markdown 生成静态 html 页面的简单方法。
* ...逐步添加中，欢迎 Star & Fork & PR。
...
* [@sindresorhus/type-fest](https://github.com/sindresorhus/type-fest) ⭐ 17,351 | 🐛 214 | 🌐 TypeScript | 📅 2026-08-09：基本 TypeScript 类型的集合（sindresorhus端口/ type-fest）。
...
* [@akshgpt7/youtube-deno](https://github.com/akshgpt7/youtube-deno) ⭐ 48 | 🐛 11 | 🌐 TypeScript | 📅 2021-08-13：YouTube 数据 API 的 Deno 客户端库，用于与 YouTube 进行任何交互。
...
* [@github-profile-trophy](https://github.com/ryo-ma/github-profile-trophy) ⭐ 6,631 | 🐛 32 | 🌐 TypeScript | 📅 2026-07-25：🏆 在你的 README 文件中添加动态生成的 GitHub Trophy。
...
* [@avelino/awesome-go](https://github.com/avelino/awesome-go) ⭐ 180,920 | 🐛 207 | 🌐 Go | 📅 2026-08-11。
* [@sindresorhus/awesome-nodejs](https://github.com/sindresorhus/awesome-nodejs) ⭐ 66,508 | 🐛 26 | 📅 2026-05-03。
* [@rust-unofficial/awesome-rust](https://github.com/rust-unofficial/awesome-rust) ⭐ 58,814 | 🐛 9 | 🌐 Rust | 📅 2026-08-12。
* [@jobbole/awesome-go-cn](https://github.com/jobbole/awesome-go-cn) ⭐ 7,378 | 🐛 15 | 📅 2024-05-22。
* [@dzharii/awesome-typeScript](https://github.com/dzharii/awesome-typescript) ⚠️ Archived。
* [@semlinker/awesome-typeScript](https://github.com/semlinker/awesome-typescript) ⭐ 4,043 | 🐛 102 | 📅 2026-08-09。
* ...逐步添加中，欢迎 Star & Fork & PR。

### 仓库更新日志

* [x] 2020-05-14 同步最新的 [@denolib/awesome-deno](https://github.com/denolib/awesome-deno) ⭐ 4,412 | 🐛 2 | 📅 2026-08-12 仓库内容。
* [x] 2020-05-22 全网大量搜索 Deno 中英文资源并入库，发布 v1.0 版本并收录在[《Deno 钻研之术》](https://github.com/denolib/awesome-deno) ⭐ 4,412 | 🐛 2 | 📅 2026-08-12第二篇中。
...
* [x] 2021-02-25 大幅更新：
  ...
  * [x] 将之前尚未分类的数十条进行分类
* [ ] 2021-xx-xx
  * [ ] 同步最新的 [@denolib/awesome-deno](https://github.com/denolib/awesome-deno) ⭐ 4,412 | 🐛 2 | 📅 2026-08-12 内容
  * [ ] 引入 Pagic 来展示此资源清单
...
本项目贡献者列表遵循 [all-contributors](https://github.com/all-contributors/all-contributors) ⭐ 8,087 | 🐛 90 | 🌐 MDX | 📅 2026-08-12 规范。欢迎你的参与，本仓库[贡献准则](./CONTRIBUTING.md)！
