...
* [x] 及时跟进 [@denolib/awesome-deno](https://github.com/denolib/awesome-deno) ⭐ 4,409 | 🐛 2 | 📅 2026-09-14 仓库。
...
* [doc.deno.land](https://doc.deno.land)：Deno API 查阅器，可查看官方/社区文档。
  * 中文：[@denodev/typedoc](https://github.com/denodev/typedoc) ⭐ 135 | 🐛 4 | 📅 2023-06-29。
...
* [@denoland/deno](https://github.com/denoland/deno) ⭐ 108,463 | 🐛 1,587 | 🌐 Rust | 📅 2026-09-16：🌟。Deno 核心仓库。
...
* [@denoland/deno\_std](https://github.com/denoland/deno_std) ⭐ 3,563 | 🐛 334 | 🌐 TypeScript | 📅 2026-08-03：🌟。Deno 标准库。
* [@cacjs/cac](https://github.com/cacjs/cac) ⭐ 3,132 | 🐛 36 | 🌐 TypeScript | 📅 2026-08-28：🌟。用于构建命令行应用程序的简单但功能强大的框架。
...
* 和 Deno 生态强相关的源
  * [denopkg](https://github.com/denopkg/denopkg.com) ⭐ 239 | 🐛 8 | 🌐 TypeScript | 📅 2025-08-14：在 Deno 项目中使用 GitHub 上的代码的更简单方法。
...
* [@bevry/make-deno-edition](https://github.com/bevry/make-deno-edition) ⭐ 42 | 🐛 5 | 🌐 TypeScript | 📅 2026-09-13：自动使 package.json 项目（例如 npm 软件包和 node.js 模块）与 Deno 兼容。
...
* [@drashland/drash](https://github.com/drashland/deno-drash) ⭐ 1,063 | 🐛 2 | 🌐 TypeScript | 📅 2026-09-11：零依赖性的 Deno HTTP 服务器的 REST 微框架。
...
* [@eveningkid/denodb](https://github.com/eveningkid/denodb) ⭐ 1,918 | 🐛 105 | 🌐 TypeScript | 📅 2023-10-28：适用于 Deno 的 MySQL、SQLite、MariaDB、PostgreSQL 和 MongoDB ORM。
* [@buildondata/deno-postgres](https://github.com/buildondata/deno-postgres) ⭐ 655 | 🐛 39 | 🌐 TypeScript | 📅 2025-04-24：PostgreSQL 数据库驱动程序。
* [@halvardssm/deno-nessie](https://github.com/halvardssm/deno-nessie) ⭐ 518 | 🐛 8 | 🌐 TypeScript | 📅 2024-04-10：为 PostgreSQL、MySQL 和 SQLite 创建，迁移和回滚迁移。
* [@manyuanrong/deno\_mongo](https://github.com/manyuanrong/deno_mongo) ⭐ 511 | 🐛 48 | 🌐 TypeScript | 📅 2025-03-14：MongoDB 数据库驱动程序。
* [@keroxp/deno-redis](https://github.com/keroxp/deno-redis) ⭐ 464 | 🐛 40 | 🌐 TypeScript | 📅 2026-09-13：Redis Client for Deno 的实验性实现。
...
* [@ryo-ma/deno-websocket](https://github.com/ryo-ma/deno-websocket) ⭐ 159 | 🐛 9 | 🌐 TypeScript | 📅 2023-04-30 - 🦕 一个简单的 WebSocket 库，例如 node.js 库的 ws。
...
* [@Maxim-Mazurok/sax-ts](https://github.com/Maxim-Mazurok/sax-ts) ⭐ 20 | 🐛 0 | 🌐 JavaScript | 📅 2024-03-17：从 [sax-js](https://github.com/isaacs/sax-js) ⭐ 1,156 | 🐛 98 | 🌐 JavaScript | 📅 2026-07-24 移植的 SAX 风格的 XML 解析器。
...
* [@sindresorhus/type-fest](https://github.com/sindresorhus/type-fest) ⭐ 17,409 | 🐛 229 | 🌐 TypeScript | 📅 2026-09-16：基本 TypeScript 类型的集合（sindresorhus端口/ type-fest）。
...
* [@eliassjogreen/webview](https://github.com/eliassjogreen/deno_webview) ⭐ 1,590 | 🐛 43 | 🌐 TypeScript | 📅 2025-02-25：Webview 的 Deno 绑定，这是一个用于创建基于 Web 的桌面 GUI 的小型库。
...
* [@manyuanrong/deno-smtp](https://github.com/manyuanrong/deno-smtp) ⭐ 83 | 🐛 17 | 🌐 TypeScript | 📅 2024-05-29：SMTP 的 SMTP 邮件发件人。
...
* [@github-profile-trophy](https://github.com/ryo-ma/github-profile-trophy) ⭐ 6,652 | 🐛 32 | 🌐 TypeScript | 📅 2026-07-25：🏆 在你的 README 文件中添加动态生成的 GitHub Trophy。
...
* [@avelino/awesome-go](https://github.com/avelino/awesome-go) ⭐ 184,384 | 🐛 231 | 🌐 Go | 📅 2026-09-16。
* [@sindresorhus/awesome-nodejs](https://github.com/sindresorhus/awesome-nodejs) ⭐ 66,826 | 🐛 25 | 📅 2026-09-02。
* [@rust-unofficial/awesome-rust](https://github.com/rust-unofficial/awesome-rust) ⭐ 59,380 | 🐛 12 | 🌐 Rust | 📅 2026-09-16。
...
* [@semlinker/awesome-typeScript](https://github.com/semlinker/awesome-typescript) ⭐ 4,049 | 🐛 112 | 📅 2026-08-22。
* ...逐步添加中，欢迎 Star & Fork & PR。

### 仓库更新日志

* [x] 2020-05-14 同步最新的 [@denolib/awesome-deno](https://github.com/denolib/awesome-deno) ⭐ 4,409 | 🐛 2 | 📅 2026-09-14 仓库内容。
* [x] 2020-05-22 全网大量搜索 Deno 中英文资源并入库，发布 v1.0 版本并收录在[《Deno 钻研之术》](https://github.com/denolib/awesome-deno) ⭐ 4,409 | 🐛 2 | 📅 2026-09-14第二篇中。
...
* [x] 2021-02-25 大幅更新：
  ...
  * [x] 将之前尚未分类的数十条进行分类
* [ ] 2021-xx-xx
  * [ ] 同步最新的 [@denolib/awesome-deno](https://github.com/denolib/awesome-deno) ⭐ 4,409 | 🐛 2 | 📅 2026-09-14 内容
  * [ ] 引入 Pagic 来展示此资源清单
...
本项目贡献者列表遵循 [all-contributors](https://github.com/all-contributors/all-contributors) ⭐ 8,103 | 🐛 90 | 🌐 MDX | 📅 2026-09-16 规范。欢迎你的参与，本仓库[贡献准则](./CONTRIBUTING.md)！
