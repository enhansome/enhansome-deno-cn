...
* [x] 及时跟进 [@denolib/awesome-deno](https://github.com/denolib/awesome-deno) ⭐ 4,408 | 🐛 2 | 📅 2026-09-14 仓库。
...
* [@denoland/deno](https://github.com/denoland/deno) ⭐ 108,464 | 🐛 1,593 | 🌐 Rust | 📅 2026-09-17：🌟。Deno 核心仓库。
* [@oakserver/oak](https://github.com/oakserver/oak/) ⭐ 5,407 | 🐛 52 | 🌐 TypeScript | 📅 2026-02-22：🌟。Den Web 框架。
* [@alephjs/aleph.js](https://github.com/alephjs/aleph.js) ⚠️ Archived：🌟。Deno React 全栈框架。
* [@denoland/deno\_std](https://github.com/denoland/deno_std) ⭐ 3,565 | 🐛 324 | 🌐 TypeScript | 📅 2026-09-17：🌟。Deno 标准库。
* [@cacjs/cac](https://github.com/cacjs/cac) ⭐ 3,132 | 🐛 38 | 🌐 TypeScript | 📅 2026-08-28：🌟。用于构建命令行应用程序的简单但功能强大的框架。
...
* [@oakserver/oak](https://github.com/oakserver/oak) ⭐ 5,407 | 🐛 52 | 🌐 TypeScript | 📅 2026-02-22：🌟。知名的 Deno Web 框架。
...
* [@NMathar/deno-express](https://github.com/NMathar/deno-express) ⭐ 286 | 🐛 6 | 🌐 TypeScript | 📅 2022-05-23：Node Express 已移植到 Deno。
...
* [@sindresorhus/type-fest](https://github.com/sindresorhus/type-fest) ⭐ 17,410 | 🐛 228 | 🌐 TypeScript | 📅 2026-09-17：基本 TypeScript 类型的集合（sindresorhus端口/ type-fest）。
...
* [@avelino/awesome-go](https://github.com/avelino/awesome-go) ⭐ 184,652 | 🐛 230 | 🌐 Go | 📅 2026-09-16。
* [@sindresorhus/awesome-nodejs](https://github.com/sindresorhus/awesome-nodejs) ⭐ 66,848 | 🐛 25 | 📅 2026-09-02。
* [@rust-unofficial/awesome-rust](https://github.com/rust-unofficial/awesome-rust) ⭐ 59,417 | 🐛 12 | 🌐 Rust | 📅 2026-09-18。
...
* [@semlinker/awesome-typeScript](https://github.com/semlinker/awesome-typescript) ⭐ 4,049 | 🐛 113 | 📅 2026-08-22。
* ...逐步添加中，欢迎 Star & Fork & PR。

### 仓库更新日志

* [x] 2020-05-14 同步最新的 [@denolib/awesome-deno](https://github.com/denolib/awesome-deno) ⭐ 4,408 | 🐛 2 | 📅 2026-09-14 仓库内容。
* [x] 2020-05-22 全网大量搜索 Deno 中英文资源并入库，发布 v1.0 版本并收录在[《Deno 钻研之术》](https://github.com/denolib/awesome-deno) ⭐ 4,408 | 🐛 2 | 📅 2026-09-14第二篇中。
...
* [x] 2021-02-25 大幅更新：
  ...
  * [x] 将之前尚未分类的数十条进行分类
* [ ] 2021-xx-xx
  * [ ] 同步最新的 [@denolib/awesome-deno](https://github.com/denolib/awesome-deno) ⭐ 4,408 | 🐛 2 | 📅 2026-09-14 内容
  * [ ] 引入 Pagic 来展示此资源清单
