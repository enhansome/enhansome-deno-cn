# Awesome Deno 资源全图谱 · 专注中文版 with stars
...
* [x] 及时跟进 [@denolib/awesome-deno](https://github.com/denolib/awesome-deno) ⭐ 4,411 | 🐛 2 | 📅 2026-08-14 仓库。
...
* [doc.deno.land](https://doc.deno.land)：Deno API 查阅器，可查看官方/社区文档。
  * 中文：[@denodev/typedoc](https://github.com/denodev/typedoc) ⭐ 136 | 🐛 4 | 📅 2023-06-29。
...
* [@denoland/deno](https://github.com/denoland/deno) ⭐ 108,224 | 🐛 1,512 | 🌐 Rust | 📅 2026-08-17：🌟。Deno 核心仓库。
...
* [@denoland/deno\_std](https://github.com/denoland/deno_std) ⭐ 3,558 | 🐛 309 | 🌐 TypeScript | 📅 2026-08-03：🌟。Deno 标准库。
* [@cacjs/cac](https://github.com/cacjs/cac) ⭐ 3,124 | 🐛 35 | 🌐 TypeScript | 📅 2026-06-16：🌟。用于构建命令行应用程序的简单但功能强大的框架。
* [denoify](https://github.com/garronej/denoify) ⭐ 949 | 🐛 14 | 🌐 TypeScript | 📅 2025-10-01：🌟。对于希望支持 Deno 但不想编写和维护端口的 NPM 模块作者。
* [@crewdevio/trex](https://github.com/crewdevio/Trex) ⭐ 727 | 🐛 7 | 🌐 TypeScript | 📅 2023-08-18：🌟。像 npm 一样的 deno 软件包管理。
...
* 和 Deno 生态强相关的源
  ...
  * [denopkg](https://github.com/denopkg/denopkg.com) ⭐ 239 | 🐛 9 | 🌐 TypeScript | 📅 2025-08-14：在 Deno 项目中使用 GitHub 上的代码的更简单方法。
* 基于 ES6 模块化机制的源
...
* [@crewdevio/trex](https://github.com/crewdevio/Trex) ⭐ 727 | 🐛 7 | 🌐 TypeScript | 📅 2023-08-18：🌟。像 npm 一样的 deno 软件包管理。
* [@justjavac/dvm](https://github.com/justjavac/dvm) ⭐ 708 | 🐛 1 | 🌐 Rust | 📅 2026-08-05：Deno 版本管理器：管理多个活动的 Deno 版本。
* [@umbopepato/velociraptor](https://github.com/umbopepato/velociraptor) ⭐ 670 | 🐛 20 | 🌐 TypeScript | 📅 2022-08-08：Deno 的 npm 风格脚本运行器。
...
* [@drashland/dmm](https://github.com/drashland/dmm) ⭐ 58 | 🐛 2 | 🌐 TypeScript | 📅 2025-08-25：轻量级 Deno 模块管理器
* [@denodep/dep](https://github.com/denodep/dep) ⭐ 49 | 🐛 3 | 🌐 TypeScript | 📅 2020-07-28：Deno 依赖性管理工具。
* [@bevry/make-deno-edition](https://github.com/bevry/make-deno-edition) ⭐ 42 | 🐛 5 | 🌐 TypeScript | 📅 2026-08-12：自动使 package.json 项目（例如 npm 软件包和 node.js 模块）与 Deno 兼容。
* [@irandeno/coffee](https://github.com/irandeno/coffee) ⭐ 32 | 🐛 0 | 🌐 TypeScript | 📅 2020-08-25：Deno 配置——一种类型安全、易于使用的 Deno 配置管理器。
* [@jinjor/deno-task-runner](https://github.com/jinjor/deno-task-runner) ⭐ 29 | 🐛 3 | 🌐 TypeScript | 📅 2019-01-19：像 NPM 脚本一样编写任务。
* [@BoltDoggy/dpm](https://github.com/BoltDoggy/deno#dpm) ⚠️ Archived：Deno 软件包管理器，为 Deno 安装全局命令，比如 Denoget。—— DVM。
* [@eankeen/ensure](https://github.com/eankeen/ensure) ⚠️ Archived：确保您运行的是 Deno，Typescript 或 V8 的最低版本。
* [@MarkTiedemann/dvm.cmd](https://github.com/MarkTiedemann/dvm.cmd) ⭐ 2 | 🐛 0 | 🌐 Batchfile | 📅 2021-08-09：Windows 版 Deno 版本管理器，作为单个批处理文件编写。
...
* [@drashland/drash](https://github.com/drashland/deno-drash) ⭐ 1,068 | 🐛 1 | 🌐 TypeScript | 📅 2026-08-12：零依赖性的 Deno HTTP 服务器的 REST 微框架。
* [@asos-craigmorten/opine](https://github.com/asos-craigmorten/opine) ⭐ 848 | 🐛 2 | 🌐 TypeScript | 📅 2024-01-28：从 ExpressJS 移植的快速，简约的网络框架。
* [@alosaur/alosaur](https://github.com/alosaur/alosaur) ⭐ 818 | 🐛 23 | 🌐 TypeScript | 📅 2026-07-24：具有许多装饰器的 Deno Web 框架。
* [@keroxp/servest](https://github.com/keroxp/servest) ⭐ 721 | 🐛 10 | 🌐 TypeScript | 📅 2022-10-19：渐进式 HTTP 服务器/路由器。
* [@zhmushan/abc](https://github.com/zhmushan/abc) ⭐ 596 | 🐛 10 | 🌐 TypeScript | 📅 2021-10-10：一个不错的 Deno Web 框架。
* [@sholladay/pogo](https://github.com/sholladay/pogo) ⭐ 479 | 🐛 5 | 🌐 JavaScript | 📅 2024-07-22：一个 Deno 服务端框架。
* [@syumai/dinatra](https://github.com/syumai/dinatra) ⭐ 415 | 🐛 8 | 🌐 TypeScript | 📅 2021-12-31：🌟。一个类似于 Sinatra 的轻量级 Deno Web 应用程序框架。
* [@NMathar/deno-express](https://github.com/NMathar/deno-express) ⭐ 287 | 🐛 6 | 🌐 TypeScript | 📅 2022-05-23：Node Express 已移植到 Deno。
* [@l2ig/aqua](https://github.com/l2ig/aqua) ⭐ 216 | 🐛 4 | 🌐 TypeScript | 📅 2023-12-13：用于 Deno 的小又快的 Web 框架。
* [@Caesar2011/denotrain](https://github.com/Caesar2011/denotrain) ⭐ 101 | 🐛 5 | 🌐 TypeScript | 📅 2020-11-21：带有中间件支持的多合一 Web 框架，如 Express 或 Fastify for Node.js。
* [@aaronwlee/attain](https://github.com/aaronwlee/Attain) ⭐ 79 | 🐛 8 | 🌐 TypeScript | 📅 2021-12-10：用于 Deno 的中间件 Web 框架，它使用受 Express 和 Oak 启发的 http 标准库，快速稳定地使用适当的内存。
* [@JohannLai/doa](https://github.com/JohannLai/doa) ⭐ 23 | 🐛 1 | 🌐 TypeScript | 📅 2020-12-24：一个移植自 koa 的 Deno web 框架 doa。
* ...逐步添加中，欢迎 Star & Fork & PR。

#### Web 框架 - 前端

* [@alephjs/alephjs](https://github.com/alephjs/aleph.js) ⚠️ Archived：🌟。Deno 下的 React 框架。
* ...逐步添加中，欢迎 Star & Fork & PR。

#### 环境变量

* [@pietvanzoen/deno-dotenv](https://github.com/pietvanzoen/deno-dotenv) ⚠️ Archived：Deno 下的 Dotenv。
* [@crewdevio/dino\_env](https://github.com/crewdevio/dino_env) ⭐ 17 | 🐛 1 | 🌐 TypeScript | 📅 2022-08-03:小型库，用于使用 deno 管理环境变量。
* [@cardosomarcos/deno-dotenv](https://github.com/cardosomarcos/deno-dotenv) ⭐ 8 | 🐛 1 | 🌐 TypeScript | 📅 2019-11-01：从 .env 加载 deno 项目的环境变量。
* ...逐步添加中，欢迎 Star & Fork & PR。

#### 命令行

* [@ameerthehacker/cli-spinner](https://github.com/ameerthehacker/cli-spinners) ⭐ 57 | 🐛 2 | 🌐 TypeScript | 📅 2025-03-18：在执行长任务时在终端中显示微调框。
* ...逐步添加中，欢迎 Star & Fork & PR。

#### 模板引擎

* [@syumai/dejs](https://github.com/syumai/dejs) ⭐ 146 | 🐛 4 | 🌐 TypeScript | 📅 2023-05-30：一个用于 Deno 的 ejs 模板引擎。
* [@zekth/deno\_tiny\_templates](https://github.com/zekth/deno_tiny_templates) ⭐ 5 | 🐛 0 | 🌐 TypeScript | 📅 2020-05-10：Deno 的模板渲染器。
* ...逐步添加中，欢迎 Star & Fork & PR。

#### 测试

* [@unexpectedjs/unexpected](https://github.com/unexpectedjs/unexpected) ⭐ 368 | 🐛 51 | 🌐 JavaScript | 📅 2026-04-14：可扩展的 BDD 断言工具包。
* [@asos-craigmorten/superdeno](https://github.com/asos-craigmorten/superdeno) ⭐ 123 | 🐛 1 | 🌐 TypeScript | 📅 2025-05-18：🌟。由超级代理驱动的库，用于测试 Deno HTTP 服务器。
* [@drashland/rhum](https://github.com/drashland/rhum) ⭐ 90 | 🐛 8 | 🌐 TypeScript | 📅 2024-05-31：用于 Deno 的轻量级测试框架。
* [@crewdevio/merlin](https://github.com/crewdevio/merlin) ⭐ 48 | 🐛 0 | 🌐 TypeScript | 📅 2022-05-25：Deno 的测试和基准框架 🧙‍♂️。
* [@allain/expect](https://github.com/allain/expect) ⚠️ Archived：在 Deno 中编写 Jest 的助手。
* [@udibo/mock](https://github.com/udibo/mock) ⚠️ Archived：提供实用测试工具来帮助模拟测试行为并监视测试函数的调用。
* [@bokuweb/deno-pretty-assert](https://github.com/bokuweb/deno-pretty-assert) ⚠️ Archived：一个 Deno 下的 assertEqual 库。
* ...逐步添加中，欢迎 Star & Fork & PR。

#### 数据库

* [@eveningkid/denodb](https://github.com/eveningkid/denodb) ⭐ 1,920 | 🐛 105 | 🌐 TypeScript | 📅 2023-10-28：适用于 Deno 的 MySQL、SQLite、MariaDB、PostgreSQL 和 MongoDB ORM。
* [@buildondata/deno-postgres](https://github.com/buildondata/deno-postgres) ⭐ 656 | 🐛 38 | 🌐 TypeScript | 📅 2025-04-24：PostgreSQL 数据库驱动程序。
...
* [@manyuanrong/deno\_mongo](https://github.com/manyuanrong/deno_mongo) ⭐ 512 | 🐛 48 | 🌐 TypeScript | 📅 2025-03-14：MongoDB 数据库驱动程序。
* [@keroxp/deno-redis](https://github.com/keroxp/deno-redis) ⭐ 466 | 🐛 42 | 🌐 TypeScript | 📅 2026-08-11：Redis Client for Deno 的实验性实现。
...
* [@ryo-ma/deno-websocket](https://github.com/ryo-ma/deno-websocket) ⭐ 160 | 🐛 9 | 🌐 TypeScript | 📅 2023-04-30 - 🦕 一个简单的 WebSocket 库，例如 node.js 库的 ws。
* [@keroxp/deno-ws](https://github.com/keroxp/deno-ws) ⭐ 26 | 🐛 1 | 🌐 TypeScript | 📅 2019-01-07：一个 Websocket 服务器的实验性实现。
* [@JohanWinther/websocket\_server](https://github.com/JohanWinther/websocket_server) ⭐ 10 | 🐛 3 | 🌐 TypeScript | 📅 2021-04-18：WebSocket 服务器库 🔌。
* [@drashland/sockets](https://github.com/drashland/sockets) ⚠️ Archived - 用于 Deno 的 WebSocket 库。
* ...逐步添加中，欢迎 Star & Fork & PR。
...
* [@buttercubz/commands](https://github.com/buttercubz/commands) ⚠️ Archived：为 Node.js 和 Deno 创建命令快捷方式。
* [@ekaragodin/clone](https://github.com/ekaragodin/clone) ⭐ 4 | 🐛 1 | 🌐 TypeScript | 📅 2026-03-30：一个方便克隆 Github 仓库到本地的简单实用程序。
* ...逐步添加中，欢迎 Star & Fork & PR。

#### 应用级别

* [@PandawanFr/deno\_notify](https://github.com/PandawanFr/deno_notify) ⭐ 50 | 🐛 2 | 🌐 TypeScript | 📅 2023-03-07：在所有平台上发送桌面通知。
* ...逐步添加中，欢迎 Star & Fork & PR。

#### 数据类型处理

* [@denorg/qrcode](https://github.com/denorg/qrcode) ⭐ 45 | 🐛 7 | 🌐 JavaScript | 📅 2026-07-25：Deno 的 QR 码图像生成器。
...
* [@Maxim-Mazurok/sax-ts](https://github.com/Maxim-Mazurok/sax-ts) ⭐ 20 | 🐛 0 | 🌐 JavaScript | 📅 2024-03-17：从 [sax-js](https://github.com/isaacs/sax-js) ⭐ 1,158 | 🐛 98 | 🌐 JavaScript | 📅 2026-07-24 移植的 SAX 风格的 XML 解析器。
...
* [@burhanahmeed/time.ts](https://github.com/burhanahmeed/time.ts) ⭐ 10 | 🐛 2 | 🌐 TypeScript | 📅 2020-11-25：Time.ts，简便的 Deno 时区操作。
* [@denolib/marked](https://github.com/denolib/marked/) ⭐ 9 | 🐛 1 | 🌐 TypeScript | 📅 2020-03-02：Markdown -> HTML 转换器。
* [@denolib/marked](https://github.com/denolib/marked/) ⭐ 9 | 🐛 1 | 🌐 TypeScript | 📅 2020-03-02：Markdown 到 HTML 转换器。
* [@denolib/camelcase](https://github.com/denolib/camelcase) ⭐ 8 | 🐛 0 | 🌐 TypeScript | 📅 2019-02-17：将破折号/点号/下划线/空格分隔的字符串转换为驼峰式；示例：foo-bar→fooBar。
* [@manyuanrong/bytes\_formater](https://github.com/manyuanrong/bytes_formater) ⭐ 8 | 🐛 1 | 🌐 TypeScript | 📅 2020-11-10：格式化字节（Uint8Array，ArrayBufferView ...）输出，在调试 IO 功能时很有用。
* [@hayd/deno-globrex](https://github.com/hayd/deno-globrex) ⭐ 7 | 🐛 0 | 🌐 TypeScript | 📅 2019-02-11：glob 转 regex。
* [@OnikurYH/deno-prettystring](https://github.com/OnikurYH/deno-prettystring) ⭐ 7 | 🐛 0 | 🌐 TypeScript | 📅 2019-10-27：格式化，修剪和删除字符串中字符之间的多余空白。
* [@manyuanrong/deno-checksum](https://github.com/manyuanrong/deno-checksum) ⚠️ Archived：SHA1/MD5 算法。
* [@denolib/qs](https://github.com/denolib/qs) ⚠️ Archived：具有嵌套支持的 querystring 解析器。
* [@denolib/qs](https://github.com/denolib/qs) ⚠️ Archived：具有嵌套支持的查询字符串解析器。
* [@zekth/deno\_case\_style](https://github.com/zekth/deno_case_style) ⭐ 4 | 🐛 0 | 🌐 TypeScript | 📅 2019-05-13：不同大小写样式的字符串验证器和格式化程序，例如 camelCase 等。
* [@matteocrippa/fossil](https://github.com/matteocrippa/fossil) ⭐ 4 | 🐛 0 | 🌐 TypeScript | 📅 2020-06-22：值类型验证套件。
* [@denorg/invert-kv](https://github.com/denorg/invert-kv) ⭐ 3 | 🐛 1 | 🌐 TypeScript | 📅 2020-06-01：在 Deno 中反转键/值对。
* [@codetyphon/denoshort](https://github.com/codetyphon/denoshort) ⭐ 1 | 🐛 0 | 🌐 HTML | 📅 2021-02-05：URL 缩短器。
* [@zekth/deno\_random\_interval](https://github.com/zekth/deno_random_interval) ⭐ 1 | 🐛 0 | 🌐 TypeScript | 📅 2019-05-13：帮助器生成随机间隔。
* [@nekobato/deno-yaml](https://github.com/muhibbudins/deno-yaml)：一个使用 Deno 的简单 Yaml 解析器。
* ...逐步添加中，欢迎 Star & Fork & PR。

#### IDE 插件

* [@denoland/vscode-deno](https://github.com/denoland/vscode_deno) ⭐ 1,548 | 🐛 125 | 🌐 TypeScript | 📅 2026-07-02：🌟。VS Code 扩展。
...
* [@xcatliu/pagic](https://github.com/xcatliu/pagic) ⭐ 1,657 | 🐛 12 | 🌐 JavaScript | 📅 2023-09-19：用 Deno 构建从 markdown 生成静态 html 页面的简单方法。
* ...逐步添加中，欢迎 Star & Fork & PR。

#### 从 Node 到 Deno

* [@garronej/denoify](https://github.com/garronej/denoify) ⭐ 949 | 🐛 14 | 🌐 TypeScript | 📅 2025-10-01：🌟。对于希望支持 Deno 但不想编写和维护端口的 NPM 模块作者。
* ...逐步添加中，欢迎 Star & Fork & PR。

#### TypeScript 相关

* [@sindresorhus/type-fest](https://github.com/sindresorhus/type-fest) ⭐ 17,360 | 🐛 221 | 🌐 TypeScript | 📅 2026-08-15：基本 TypeScript 类型的集合（sindresorhus端口/ type-fest）。
...
* [@eliassjogreen/denon](https://github.com/eliassjogreen/denon) ⭐ 1,108 | 🐛 27 | 🌐 TypeScript | 📅 2024-03-21：像 Nodemon 的 Deno 库。
* [@manyuanrong/deno-deamon](https://github.com/manyuanrong/deno-deamon) ⭐ 14 | 🐛 1 | 🌐 TypeScript | 📅 2019-12-18：使 Deno 程序在后台运行。
* ...逐步添加中，欢迎 Star & Fork & PR。

#### 热更新

* [@joakimunge/denoliver](https://github.com/joakimunge/denoliver) ⭐ 104 | 🐛 5 | 🌐 TypeScript | 📅 2025-07-24：具有实时重新加载功能的简单，无依赖的文件服务器。
* [@jinjor/watch](https://github.com/jinjor/deno-watch) ⭐ 44 | 🐛 2 | 🌐 TypeScript | 📅 2020-06-02：文件观察器（热更新）。
* ...逐步添加中，欢迎 Star & Fork & PR。

#### 容器化 & 自动化 & 云

* [@TencentCloudBase/cloudbase-framework/.../framework-plugin-deno](https://github.com/TencentCloudBase/cloudbase-framework/tree/master/packages/framework-plugin-deno) ⚠️ Archived：云开发 CloudBase Framework 框架「Deno」插件。
* [@hayd/deno-docker](https://github.com/hayd/deno-docker) ⭐ 1,018 | 🐛 18 | 🌐 Dockerfile | 📅 2026-08-06：hayd 的几个 docker 映像。
* [@divy-work/autopilot](https://github.com/divy-work/autopilot-deno) ⭐ 503 | 🐛 9 | 🌐 Rust | 📅 2022-07-22：🌟。用于 Deno 的跨平台桌面自动化框架。
...
* [@garronej/evt](https://github.com/garronej/evt) ⭐ 461 | 🐛 8 | 🌐 TypeScript | 📅 2025-10-01：EventEmitter 的安全替代品。
...
* [@manyuanrong/deno-smtp](https://github.com/manyuanrong/deno-smtp) ⭐ 83 | 🐛 18 | 🌐 TypeScript | 📅 2024-05-29：SMTP 的 SMTP 邮件发件人。
* [@jinjor/deno-playground](https://github.com/jinjor/deno-playground) ⭐ 60 | 🐛 0 | 🌐 TypeScript | 📅 2019-01-12：提供一些 Deno 自定义模块。
* [@manyuanrong/sql-builder](https://github.com/manyuanrong/sql-builder) ⭐ 55 | 🐛 9 | 🌐 TypeScript | 📅 2023-01-09：SQL 查询生成器。
* [@zhmushan/router](https://github.com/zhmushan/router) ⭐ 54 | 🐛 2 | 🌐 TypeScript | 📅 2026-03-02：高性能基本路由器可在任何地方工作。
* [@manyuanrong/deno-plugin-prepare](https://github.com/manyuanrong/deno-plugin-prepare) ⭐ 48 | 🐛 0 | 🌐 TypeScript | 📅 2020-10-13：一个用于管理 Deno 原生插件依赖关系的库。
* [@akshgpt7/youtube-deno](https://github.com/akshgpt7/youtube-deno) ⭐ 47 | 🐛 11 | 🌐 TypeScript | 📅 2021-08-13：YouTube 数据 API 的 Deno 客户端库，用于与 YouTube 进行任何交互。
* [@timonson/gentleRpc](https://github.com/timonson/gentleRpc) ⭐ 45 | 🐛 2 | 🌐 TypeScript | 📅 2024-05-18：用于 Deno 和浏览器的 JSON-RPC 2.0 TypeScript 库。
* [@hashrock/deno-opn](https://github.com/hashrock/deno-opn) ⚠️ Archived：一个可以打开网站、(可执行)文件之类资源的跨平台工具。
* [@thewizardbear/maze\_generator](https://github.com/thewizardbear/maze_generator) ⭐ 38 | 🐛 7 | 🌐 JavaScript | 📅 2021-05-09：用于生成、求解、分析和显示迷宫的 Javascript 模块。
* [@luvies/lazy](https://github.com/luvies/lazy) ⚠️ Archived：类似于 linq 的惰性求值迭代模块。
...
* [@hayd/deno-using](https://github.com/hayd/deno-using) ⭐ 11 | 🐛 0 | 🌐 TypeScript | 📅 2020-05-10：带有 Deno 语句的 Python 样式。
* [@AlpacaBi/qrcode\_terminal](https://github.com/AlpacaBi/qrcode_terminal) ⭐ 11 | 🐛 1 | 🌐 JavaScript | 📅 2021-03-17。
* [@denorg/recursive-readdir](https://github.com/denorg/recursive-readdir) ⭐ 8 | 🐛 2 | 🌐 TypeScript | 📅 2020-06-01：递归读取 Deno 中的目录。
* [@denorg/online](https://github.com/denorg/online) ⭐ 7 | 🐛 1 | 🌐 TypeScript | 📅 2020-06-01：检查您当前是否将 Deno 运行在线上。
* [@lucascaro/denoversion](https://github.com/lucascaro/denoversion) ⭐ 7 | 🐛 1 | 🌐 TypeScript | 📅 2019-05-02：Deno 的 SemVer + Git 版本管理。
* [@code-hex/deno-context](https://github.com/code-hex/deno-context) ⭐ 6 | 🐛 0 | 🌐 TypeScript | 📅 2020-05-17：将期限，取消和其他要求范围的值传播给多个 Promise，行为就像 Go 的上下文。
* [@matteocrippa/microraptor](https://github.com/matteocrippa/microraptor) ⭐ 6 | 🐛 0 | 🌐 TypeScript | 📅 2020-06-22：轻量级框架，可通过验证轻松进行网络路由。
* [@youngjuning/duck](https://github.com/youngjuning/duck) ⭐ 4 | 🐛 0 | 🌐 TypeScript | 📅 2020-08-27：一个简单的扫描 controller 并自动注册路由的中间件。
...
* [deno-playground.now.sh](https://deno-playground.now.sh)。
  * [@maman/deno-playground](https://github.com/maman/deno-playground) ⭐ 60 | 🐛 0 | 🌐 TypeScript | 📅 2021-03-22。
...
* [@github-profile-trophy](https://github.com/ryo-ma/github-profile-trophy) ⭐ 6,632 | 🐛 32 | 🌐 TypeScript | 📅 2026-07-25：🏆 在你的 README 文件中添加动态生成的 GitHub Trophy。
* [@vicky-gonsalves/deno\_rest](https://github.com/vicky-gonsalves/deno_rest) ⭐ 162 | 🐛 3 | 🌐 TypeScript | 📅 2025-02-09：RESTful API 的样板。
...
* [@TencentCloudBase/cloudbase-templates/.../deno-cloud-app](https://github.com/TencentCloudBase/cloudbase-templates/tree/master/deno) ⚠️ Archived- 可以通过 CLI 一键部署的 Deno 云应用模板。
* [@tamasszoke/deno-seed](https://github.com/tamasszoke/deno-seed) ⭐ 54 | 🐛 2 | 🌐 JavaScript | 📅 2022-02-10 - 完整的开发样板 🌱。
...
* [twitter@deno\_land](https://twitter.com/deno_land)：Deno Land 官方推特。
* ...逐步添加中，欢迎 Star & Fork & PR。
...
* [@avelino/awesome-go](https://github.com/avelino/awesome-go) ⭐ 181,294 | 🐛 212 | 🌐 Go | 📅 2026-08-16。
* [@sindresorhus/awesome-nodejs](https://github.com/sindresorhus/awesome-nodejs) ⭐ 66,539 | 🐛 26 | 📅 2026-05-03。
* [@rust-unofficial/awesome-rust](https://github.com/rust-unofficial/awesome-rust) ⭐ 58,866 | 🐛 7 | 🌐 Rust | 📅 2026-08-17。
* [@jobbole/awesome-go-cn](https://github.com/jobbole/awesome-go-cn) ⭐ 7,375 | 🐛 15 | 📅 2024-05-22。
* [@dzharii/awesome-typeScript](https://github.com/dzharii/awesome-typescript) ⚠️ Archived。
* [@semlinker/awesome-typeScript](https://github.com/semlinker/awesome-typescript) ⭐ 4,043 | 🐛 105 | 📅 2026-08-09。
* ...逐步添加中，欢迎 Star & Fork & PR。

### 仓库更新日志

* [x] 2020-05-14 同步最新的 [@denolib/awesome-deno](https://github.com/denolib/awesome-deno) ⭐ 4,411 | 🐛 2 | 📅 2026-08-14 仓库内容。
* [x] 2020-05-22 全网大量搜索 Deno 中英文资源并入库，发布 v1.0 版本并收录在[《Deno 钻研之术》](https://github.com/denolib/awesome-deno) ⭐ 4,411 | 🐛 2 | 📅 2026-08-14第二篇中。
* [x] 2020-04-14 跟进最新的（180+ Star） [@olivewind/awesome-deno-cn](https://github.com/olivewind/awesome-deno) ⚠️ Archived 仓库内容。
* [x] 2020-05-17 跟进中文化后大改版的（200+ Star） [@olivewind/awesome-deno-cn](https://github.com/olivewind/awesome-deno-cn) ⚠️ Archived 仓库内容。
...
* [x] 2021-02-25 大幅更新：
  ...
  * [x] 将之前尚未分类的数十条进行分类
* [ ] 2021-xx-xx
  * [ ] 同步最新的 [@denolib/awesome-deno](https://github.com/denolib/awesome-deno) ⭐ 4,411 | 🐛 2 | 📅 2026-08-14 内容
  * [ ] 引入 Pagic 来展示此资源清单
...
本项目贡献者列表遵循 [all-contributors](https://github.com/all-contributors/all-contributors) ⭐ 8,089 | 🐛 90 | 🌐 MDX | 📅 2026-08-17 规范。欢迎你的参与，本仓库[贡献准则](./CONTRIBUTING.md)！
