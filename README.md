...
* [x] 及时跟进 [@denolib/awesome-deno](https://github.com/denolib/awesome-deno) ⭐ 4,410 | 🐛 2 | 📅 2026-08-14 仓库。
...
* [@denoland/deno](https://github.com/denoland/deno) ⭐ 108,259 | 🐛 1,505 | 🌐 Rust | 📅 2026-08-19：🌟。Deno 核心仓库。
...
* [@cacjs/cac](https://github.com/cacjs/cac) ⭐ 3,123 | 🐛 35 | 🌐 TypeScript | 📅 2026-06-16：🌟。用于构建命令行应用程序的简单但功能强大的框架。
...
* [@drashland/drash](https://github.com/drashland/deno-drash) ⭐ 1,067 | 🐛 1 | 🌐 TypeScript | 📅 2026-08-12：零依赖性的 Deno HTTP 服务器的 REST 微框架。
...
* [@keroxp/servest](https://github.com/keroxp/servest) ⭐ 720 | 🐛 10 | 🌐 TypeScript | 📅 2022-10-19：渐进式 HTTP 服务器/路由器。
...
* [@eveningkid/denodb](https://github.com/eveningkid/denodb) ⭐ 1,919 | 🐛 105 | 🌐 TypeScript | 📅 2023-10-28：适用于 Deno 的 MySQL、SQLite、MariaDB、PostgreSQL 和 MongoDB ORM。
* [@buildondata/deno-postgres](https://github.com/buildondata/deno-postgres) ⭐ 655 | 🐛 38 | 🌐 TypeScript | 📅 2025-04-24：PostgreSQL 数据库驱动程序。
...
* [@sindresorhus/type-fest](https://github.com/sindresorhus/type-fest) ⭐ 17,365 | 🐛 223 | 🌐 TypeScript | 📅 2026-08-15：基本 TypeScript 类型的集合（sindresorhus端口/ type-fest）。
...
* [@github-profile-trophy](https://github.com/ryo-ma/github-profile-trophy) ⭐ 6,637 | 🐛 32 | 🌐 TypeScript | 📅 2026-07-25：🏆 在你的 README 文件中添加动态生成的 GitHub Trophy。
...
* [@avelino/awesome-go](https://github.com/avelino/awesome-go) ⭐ 181,508 | 🐛 213 | 🌐 Go | 📅 2026-08-19。
* [@sindresorhus/awesome-nodejs](https://github.com/sindresorhus/awesome-nodejs) ⭐ 66,558 | 🐛 26 | 📅 2026-05-03。
* [@rust-unofficial/awesome-rust](https://github.com/rust-unofficial/awesome-rust) ⭐ 58,896 | 🐛 7 | 🌐 Rust | 📅 2026-08-18。
...
* [@semlinker/awesome-typeScript](https://github.com/semlinker/awesome-typescript) ⭐ 4,042 | 🐛 105 | 📅 2026-08-09。
* ...逐步添加中，欢迎 Star & Fork & PR。

### 仓库更新日志

* [x] 2020-05-14 同步最新的 [@denolib/awesome-deno](https://github.com/denolib/awesome-deno) ⭐ 4,410 | 🐛 2 | 📅 2026-08-14 仓库内容。
* [x] 2020-05-22 全网大量搜索 Deno 中英文资源并入库，发布 v1.0 版本并收录在[《Deno 钻研之术》](https://github.com/denolib/awesome-deno) ⭐ 4,410 | 🐛 2 | 📅 2026-08-14第二篇中。
...
* [x] 2021-02-25 大幅更新：
  ...
  * [x] 将之前尚未分类的数十条进行分类
* [ ] 2021-xx-xx
  * [ ] 同步最新的 [@denolib/awesome-deno](https://github.com/denolib/awesome-deno) ⭐ 4,410 | 🐛 2 | 📅 2026-08-14 内容
  * [ ] 引入 Pagic 来展示此资源清单
...
本项目贡献者列表遵循 [all-contributors](https://github.com/all-contributors/all-contributors) ⭐ 8,091 | 🐛 90 | 🌐 MDX | 📅 2026-08-17 规范。欢迎你的参与，本仓库[贡献准则](./CONTRIBUTING.md)！
